...
//		g2.drawImage(tile[1].image, 6 * gp.tileSize, 2 * gp.tileSize, gp.tileSize, gp.tileSize, null);
//		g2.drawImage(tile[1].image, 6 * gp.tileSize, 3 * gp.tileSize, gp.tileSize, gp.tileSize, null);
