...
public class Player extends Entity{
	...
	public void getPlayerImage() {
	    try {
	        up1 = ImageIO.read(getClass().getResourceAsStream("/player/walking sprites/boy_down_1.png"));
	        up2 = ImageIO.read(getClass().getResourceAsStream("/player/walking sprites/boy_down_2.png"));

	        down1 = ImageIO.read(getClass().getResourceAsStream("/player/walking sprites/boy_up_1.png"));
	        down2 = ImageIO.read(getClass().getResourceAsStream("/player/walking sprites/boy_up_2.png"));
